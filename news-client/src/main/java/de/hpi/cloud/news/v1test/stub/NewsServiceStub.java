...
/**
 * Base stub class for News API.
 *
 * <p>This class is for advanced usage and reflects the underlying API directly.
 */
@Generated("by gapic-generator")
@BetaApi("A restructuring of stub classes is planned, so this may break in the future")
public abstract class NewsServiceStub implements BackgroundResource {


  public UnaryCallable<ListArticlesRequest, ListArticlesResponse> listArticlesCallable() {
    throw new UnsupportedOperationException("Not implemented: listArticlesCallable()");
  }

  public UnaryCallable<GetArticleRequest, Article> getArticleCallable() {
    throw new UnsupportedOperationException("Not implemented: getArticleCallable()");
  }

  public UnaryCallable<ListAuthorsRequest, ListAuthorsResponse> listAuthorsCallable() {
    throw new UnsupportedOperationException("Not implemented: listAuthorsCallable()");
  }

  public UnaryCallable<GetAuthorRequest, Author> getAuthorCallable() {
    throw new UnsupportedOperationException("Not implemented: getAuthorCallable()");
  }
